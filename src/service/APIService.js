 ...
 */
const newUserSignUp = (signUpObject) => {
    return userAPIServices.userServicies(process.env.VUE_APP_SIGN_UP_API_PATH, signUpObject);
}
...
const userLogIn = (logInObject) => {
    return userAPIServices.userServicies(process.env.VUE_APP_LOG_IN_API_PATH, logInObject);
}
 ...
 */
const sendResetLink = (forgotPasswordObject) => {
    return userAPIServices.userServicies(process.env.VUE_APP_RESET_API_PATH, forgotPasswordObject);
}
 ...
 */
const resetNewPassword = (resetPasswordObject, token) => {
    return userAPIServices.userServicies(process.env.VUE_APP_RESET_NEW_PASSWPRD_API_PATH + token, resetPasswordObject);
}
